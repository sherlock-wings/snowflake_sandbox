/*
  Load English stop words into BLUESKY_DB.PFC.STOPWORDS_ENGLISH table
  
  This script inserts a comprehensive list of English stop words based on
  NLTK and spaCy standard stop word lists, including contractions.
*/

INSERT INTO BLUESKY_DB.PFC.STOPWORDS_ENGLISH (WORD) VALUES
('a'), ('about'), ('above'), ('after'), ('again'), ('against'), ('all'), ('am'), ('an'), ('and'),
('any'), ('are'), ('aren''t'), ('as'), ('at'), ('be'), ('because'), ('been'), ('before'), ('being'),
('below'), ('between'), ('both'), ('but'), ('by'), ('can'), ('cannot'), ('can''t'), ('could'), ('couldn''t'),
