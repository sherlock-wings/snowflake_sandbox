...
grant role sherlockwings_wh_um_ar          to role sherlockwings_engineer_fr;
grant role sherlockwings_edw_db_full_ar    to role sherlockwings_admin_fr;
grant role sherlockwings_wh_o_ar           to role sherlockwings_admin_fr;
...
-- MODEL access
GRANT USAGE ON ALL MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_R_AR;
GRANT READ ON ALL MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_R_AR;
GRANT USAGE ON FUTURE MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_R_AR;
GRANT READ ON FUTURE MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_R_AR;
...
-- MODEL access
GRANT USAGE ON ALL MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_RW_AR;
GRANT READ ON ALL MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_RW_AR;
GRANT USAGE ON FUTURE MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_RW_AR;
GRANT READ ON FUTURE MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_RW_AR;
GRANT WRITE ON FUTURE MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_RW_AR;
GRANT WRITE ON ALL MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_RW_AR;
...
-- MODEL access
GRANT OWNERSHIP ON ALL MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_FULL_AR COPY CURRENT GRANTS;
GRANT OWNERSHIP ON FUTURE MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_FULL_AR;
GRANT WRITE ON FUTURE MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_FULL_AR;
GRANT WRITE ON ALL MODELS IN SCHEMA DEV_EDW_DB.MODEL TO ROLE DEV_EDW_DB_MODEL_FULL_AR;
...
-- MODEL access
GRANT USAGE ON ALL MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_R_AR;
GRANT READ ON ALL MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_R_AR;
GRANT USAGE ON FUTURE MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_R_AR;
GRANT READ ON FUTURE MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_R_AR;
...
-- MODEL access
GRANT USAGE ON ALL MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_RW_AR;
GRANT READ ON ALL MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_RW_AR;
GRANT USAGE ON FUTURE MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_RW_AR;
GRANT READ ON FUTURE MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_RW_AR;
GRANT WRITE ON FUTURE MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_RW_AR;
GRANT WRITE ON ALL MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_RW_AR;
...
-- MODEL access
GRANT OWNERSHIP ON ALL MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_FULL_AR COPY CURRENT GRANTS;
GRANT OWNERSHIP ON FUTURE MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_FULL_AR;
GRANT WRITE ON FUTURE MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_FULL_AR;
GRANT WRITE ON ALL MODELS IN SCHEMA QA_EDW_DB.MODEL TO ROLE QA_EDW_DB_MODEL_FULL_AR;
...
-- MODEL access
GRANT USAGE ON ALL MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_R_AR;
GRANT READ ON ALL MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_R_AR;
GRANT USAGE ON FUTURE MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_R_AR;
GRANT READ ON FUTURE MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_R_AR;
...
-- MODEL access
GRANT USAGE ON ALL MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_RW_AR;
GRANT READ ON ALL MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_RW_AR;
GRANT USAGE ON FUTURE MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_RW_AR;
GRANT READ ON FUTURE MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_RW_AR;
GRANT WRITE ON FUTURE MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_RW_AR;
GRANT WRITE ON ALL MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_RW_AR;
...
-- MODEL access
GRANT OWNERSHIP ON ALL MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_FULL_AR COPY CURRENT GRANTS;
GRANT OWNERSHIP ON FUTURE MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_FULL_AR;
GRANT WRITE ON FUTURE MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_FULL_AR;
GRANT WRITE ON ALL MODELS IN SCHEMA PROD_EDW_DB.MODEL TO ROLE PROD_EDW_DB_MODEL_FULL_AR;
