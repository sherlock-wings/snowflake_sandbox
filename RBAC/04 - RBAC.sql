...
GRANT CREATE TABLE ON SCHEMA "DEV_EDW_DB"."MODEL" TO ROLE "DEV_EDW_DB_MODEL_RW_AR"; -- Custom grant; not originally present in Roleout's initial RBAC Script
...
GRANT CREATE TABLE ON SCHEMA "DEV_EDW_DB"."RAW" TO ROLE "DEV_EDW_DB_RAW_RW_AR";  -- Custom grant; not originally present in Roleout's initial RBAC Script
...
GRANT CREATE TABLE ON SCHEMA "DEV_EDW_DB"."STAGE" TO ROLE "DEV_EDW_DB_STAGE_RW_AR";  -- Custom grant; not originally present in Roleout's initial RBAC Script
...
GRANT CREATE TABLE ON SCHEMA "PROD_EDW_DB"."MODEL" TO ROLE "PROD_EDW_DB_MODEL_RW_AR";  -- Custom grant; not originally present in Roleout's initial RBAC Script
...
GRANT CREATE TABLE ON SCHEMA "PROD_EDW_DB"."RAW" TO ROLE "PROD_EDW_DB_RAW_RW_AR";  -- Custom grant; not originally present in Roleout's initial RBAC Script
...
GRANT CREATE TABLE ON SCHEMA "PROD_EDW_DB"."STAGE" TO ROLE "PROD_EDW_DB_STAGE_RW_AR";  -- Custom grant; not originally present in Roleout's initial RBAC Script
...
GRANT CREATE TABLE ON SCHEMA "QA_EDW_DB"."MODEL" TO ROLE "QA_EDW_DB_MODEL_RW_AR";  -- Custom grant; not originally present in Roleout's initial RBAC Script
...
GRANT CREATE TABLE ON SCHEMA "QA_EDW_DB"."RAW" TO ROLE "QA_EDW_DB_RAW_RW_AR";  -- Custom grant; not originally present in Roleout's initial RBAC Script
...
GRANT CREATE TABLE ON SCHEMA "QA_EDW_DB"."STAGE" TO ROLE "QA_EDW_DB_STAGE_RW_AR";  -- Custom grant; not originally present in Roleout's initial RBAC Script
...
GRANT CREATE TABLE ON DATABASE "SANDBOX_EDW_DB" TO ROLE "SANDBOX_EDW_DB_RW_AR";  -- Custom grant; not originally present in Roleout's initial RBAC Script
